...
router.put('/restaurant/:restaurantId/category/:category', requireRole('OWNER', 'MANAGER'), menuItemController.renameCategory);
router.delete('/restaurant/:restaurantId/category/:category', requireRole('OWNER', 'MANAGER'), menuItemController.deleteCategory);
